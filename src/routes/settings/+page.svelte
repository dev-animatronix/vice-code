...
<div class="h-12 w-full flex items-center justify-between px-4 overflow-visible">
  <a href="/dashboard" class="flex flex-row gap-3 text-xl m-0 items-center leading-normal">
    <img src="/favicon.svg" class="w-7 h-7"> Vice Code
  </a>
  <div>
